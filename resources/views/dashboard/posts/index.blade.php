...
@section('container')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="/dashboard/posts/create" class="btn btn-primary shadow-sm mt-sm-0 mt-3">
                            ...
                            @foreach ($posts as $post)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="/dashboard/posts/{{ $post->slug }}/edit" class="btn btn-warning text-white py-0 px-2"
